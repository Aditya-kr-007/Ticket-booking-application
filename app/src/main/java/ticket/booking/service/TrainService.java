...
public class TrainService {
    ...
    private static final String TRAIN_DB_PATH = getLocalDbPath("trains.json");
    ...
    private static String getLocalDbPath(String fileName) {
        String appRootPath = "src/main/java/ticket/booking/localDb/" + fileName;
        if (new File(appRootPath).exists()) {
            return appRootPath;
        }
        return "app/src/main/java/ticket/booking/localDb/" + fileName;
    }
